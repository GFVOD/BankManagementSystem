...
public class TransactionsUser extends JPanel {
	private JTable table;

	/**
	 * Create the panel.
	 */
	public TransactionsUser(String username,UserPage_FourthFrame user) {
		...
		btnShowTransactions.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String query="select CustomerId, TransferredTo, TransferredAmount from Transactions where TransferredBy=?";
				try {
